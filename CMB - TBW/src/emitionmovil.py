...
def convert():
	...
	archivelinkprincipal = os.path.join('..', 'data', 'in', 'datalink', 'PRINCIPAL', 'PRINCIPALES_1.xlsx');
	archivelinksecondary = os.path.join('..', 'data', 'in', 'datalink', 'SECUNDARIAS','SECUNDARIAS_1.xlsx');
	archivelinktm = os.path.join('..', 'data', 'in', 'datalink', 'TM', 'TM_1.xlsx');
	...
	archive1 = os.path.join('..', 'data', 'in', 'datalink', 'SECUNDARIAS', 'secundary_HABIL_binding.csv')
	archive2 = os.path.join('..', 'data', 'in', 'datalink', 'SECUNDARIAS', 'secundary_NOHAB_binding.csv')
